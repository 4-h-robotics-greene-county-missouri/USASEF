...
void moveWiiJoystick(){
 moveDifferential(map(getNunValue(YSTICK),30,220,-1*MAXSPEED,MAXSPEED),map(getNunValue(XSTICK),30,220,-1*MAXSPEED,MAXSPEED));
 }
...
*/
  ...
  leftServo.write(LEFT_CENTER + leftSpeed);               //sends the new value to the servo
 }
